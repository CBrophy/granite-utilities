...
public class VectorToolsTest {
    ...
    public void testEuclideanDistance() {
        ...
        assertEquals(hypotenuse(center[0], v1[0], center[1], v1[1]), VectorTools.euclideanDistance(center, v1), 0.01);
        assertEquals(hypotenuse(center[0], v2[0], center[1], v2[1]), VectorTools.euclideanDistance(center, v2), 0.01);
        assertEquals(hypotenuse(center[0], v3[0], center[1], v3[1]), VectorTools.euclideanDistance(center, v3), 0.01);
        assertEquals(hypotenuse(center[0], v4[0], center[1], v4[1]), VectorTools.euclideanDistance(center, v4), 0.01);
        assertEquals(hypotenuse(center[0], v5[0], center[1], v5[1]), VectorTools.euclideanDistance(center, v5), 0.01);
        assertEquals(hypotenuse(center[0], v6[0], center[1], v6[1]), VectorTools.euclideanDistance(center, v6), 0.01);
        assertEquals(hypotenuse(center[0], v7[0], center[1], v7[1]), VectorTools.euclideanDistance(center, v7), 0.01);
        assertEquals(hypotenuse(center[0], v8[0], center[1], v8[1]), VectorTools.euclideanDistance(center, v8), 0.01);
