...
public class StatsToolsTest {
    ...
    public void testVariance() {
        ...
        double expected = (Math.pow(20.0 - mean, 2) + Math.pow(12.0 - mean, 2) + Math.pow(30.0 - mean, 2)) / 2.0;
    ...
    public void testStandardDeviation() {
        ...
        double mean = (20.0 + 12.0 + 30.0) / 3.0;
        double variance = (Math.pow(20.0 - mean, 2) + Math.pow(12.0 - mean, 2) + Math.pow(30.0 - mean, 2)) / 2.0;
