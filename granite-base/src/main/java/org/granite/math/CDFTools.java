...
public final class CDFTools<T extends Number> {
  ...
  public CDFTools(
    ...
    checkArgument(this.minimumTimestamp.isBefore(this.maximumTimestamp),
        "minimumTimestamp must come before maximumTimestamp");
  ...
  private int calculateTimestampEpoch(final LocalDateTime timestamp) {
    ...
    final double minutesBetween = (double) Duration.between(this.minimumTimestamp, timestamp)
        .toMinutes();
